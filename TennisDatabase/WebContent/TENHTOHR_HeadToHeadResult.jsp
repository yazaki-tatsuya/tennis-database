...
<title>Head To Head</title>
	...
	<center>
		...
		%>
		[ アクセスカウンター： <b><%=ac.GetAccessCount2("TENHTOHR")%></b> ]	
		<br /><br />	
	</center>
</head>
<body>
<div style="width:100%; overflow-y:scroll;">
<table border="3" style="border-collapse: collapse" width="1200">
<tr>
	<th width="50">HtoH No.</th>
	<th width="100">Tournament Year</th>
	<th width="150">Tournament Name</th>
	<th width="150">Tournament Round Name</th>
	<th width="150">Win Name</th>
	<th width="50">Win Seed</th>
	<th width="150">Lose Name</th>
	<th width="50">Lose Seed</th>
	<th width="150">Match Scores</th>
</tr>
<%
...
<a href="TENHTOHQ_HeadToHeadQuery2.jsp" >＞Go Back to <b>"TENHTOHQ_HeadToHeadQuery"</b> screen</a></br></br>
</body>
</html>
