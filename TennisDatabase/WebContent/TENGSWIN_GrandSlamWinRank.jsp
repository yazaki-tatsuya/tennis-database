...
<title><%=tu.TENGSWIN%></title>
	<img src="http://rainbow-engine.com/wp-content/uploads/Common/20200725_HeaderIcon.jpg" alt="" class="header_img"/>
	<center>
		<h1 class="hide"><%=tu.TENGSWIN%></h1>
		<h2 id="title" class="title_narrow">TENGSWIN</h2>
		<h3 id="subtitle" class="title_narrow"><%=tu.TENGSWIN%></h3>
		
		<%
		AccessCounter3 ac = new AccessCounter3();
		%>
		[ アクセスカウンター： <b><%=ac.GetAccessCount2("TENGSWIN")%></b> ]	
		<br />
	</center>
</head>
<body>
<p>
&#x1f3be;Ranking table of earned Grand Slam Titles/グランドスラム優勝回数のランキング&#x1f3be;
</p>
